...
class VectorDB:
    """ChromaDB vector database manager for document embeddings."""
    
    def __init__(self, collection_name: str = "documents"):
        """Initialize VectorDB with collection name."""
    ...
    def initialize_db(self) -> bool:
        ...
        try:
            ...
            persist_dir = Path(config.EMBEDDINGS_DIR)
    ...
    def add_document(self, text: str, metadata: Optional[Dict] = None, doc_id: Optional[str] = None) -> Optional[str]:
